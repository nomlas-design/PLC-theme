        ...
        <div class='header__items'>
          ...
          <div class='header__menu header__menu--right'>
            <nav class="nav nav--primary" aria-label="Main Primary Menu">
              <div class='nav__dropdownwrap'>
                <div class='nav__link nav__link--dropdown'>
                  Professional Development
                  <img class='nav__icon' src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/chevron-down.svg" alt="">
                </div>
                <div class='nav__dropdownbox'>
                  <div class='nav__dropdown'>
                    <a href='/courses' class='nav__link'>Courses & Events</a>
                    <a href='/professional-certifcates' class='nav__link'>Professional Certificates</a>
                    <a href='/courses-for-licensed-surveyors' class='nav__link'>Courses for Licensed Surveyors</a>
                  </div>
                </div>
              </div>
